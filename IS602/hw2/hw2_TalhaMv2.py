...
class CarEvaluation:
    ...
    carCount=0
    def __init__(self, car, price, safety):
        if type(safety)==type(1):
            True
        else:
            print car, 'wrong type'
        self.car=car
        self.price=price
        self.safety=safety
    ...
    def showEvaluation(self):
        print "The", self.car,"has a",self.price,"price and its safety is rated a", self.safety
    #all your logic here
...
if __name__ == "__main__":	
    ...
    eval4 = CarEvaluation("VW","Med","apple")
